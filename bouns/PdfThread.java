...
public class PdfThread implements Runnable {
    ...
    private CountedValues countedValues;
    ...
    public PdfThread(File folder, int numOfThread, int currentThreadNum, String type){
        this.folder=folder;
    ...
    public void run(){
         ...
         if (type.equals("four thread")){
            PdfFourThreadCounter.counter(folder,offset);
         }else {
